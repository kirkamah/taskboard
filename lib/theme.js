...
export const THEMES = ['light', 'dark', 'cosmic', 'parchment'];

export const THEME_LABELS = {
  light: 'Светлая',
  dark: 'Тёмная',
  cosmic: 'Космос',
  parchment: 'Дневник приключенца',
};
...
export const THEME_DESCRIPTIONS = {
  ...
  parchment: 'Пожелтевший пергамент и коричневые чернила — будто ведёшь путевой дневник.',
};
